...
const LoginFallback = () => {
  return (
    <div className="min-h-screen bg-[#EEF2F8] px-3 py-3 sm:px-4 sm:py-4">
      <div className="mx-auto grid min-h-[calc(100vh-1.5rem)] max-w-[1560px] gap-4 rounded-[30px] border border-[#DDE3F0] bg-white p-3 shadow-[0_30px_90px_rgba(46,58,131,0.16)] lg:grid-cols-[minmax(0,420px)_minmax(0,1fr)] sm:p-4 lg:p-5">
        <div className="flex items-center justify-center rounded-[26px] border border-[#EDF1F7] bg-white px-6 py-8 sm:px-8 lg:px-10">
        ...
        <div className="rounded-[26px] border border-[#DDE4F2] bg-[linear-gradient(180deg,#E5F8FF_0%,#A9DCF8_38%,#F7FBFF_100%)]" />
      </div>
    </div>
  );
};
