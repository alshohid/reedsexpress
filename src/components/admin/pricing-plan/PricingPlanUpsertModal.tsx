        ...
        setFormValues((currentValues) => {
            ...
            return {
                ...
                featureIds: hasFeature
                    ? currentValues.featureIds.filter((currentFeatureId) => currentFeatureId !== featureId)
                    ...
                    <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
                        ...
                        >
                            <div className="flex h-10 overflow-hidden rounded-md border border-[#D8DDE8] bg-white focus-within:border-[#2E3A83] focus-within:ring-2 focus-within:ring-[#2E3A83]/10">
                                <input
                                    ...
                                    onChange={(event) =>
                                        updateFormValue("dispatchFeePercentage", event.target.value)
                                    }
                                    placeholder="e.g. 10"
                        ...
                        <PricingPlanModalField label="Billing Day" htmlFor="plan-billing-day">
                            <select
                                ...
                                onChange={(event) =>
                                    updateFormValue("billingDay", event.target.value as BillingDay)
                                }
                                className="h-10 w-full rounded-md border border-[#D8DDE8] bg-white px-3 text-sm text-[#161721] outline-none focus:border-[#2E3A83] focus:ring-2 focus:ring-[#2E3A83]/10"
                            >
                        ...
                        <PricingPlanModalField label="Billing Cycle" htmlFor="plan-billing-cycle">
                            <select
                                ...
                                onChange={(event) =>
                                    updateFormValue("billingCycle", event.target.value as BillingFrequency)
                                }
                                className="h-10 w-full rounded-md border border-[#D8DDE8] bg-white px-3 text-sm text-[#161721] outline-none focus:border-[#2E3A83] focus:ring-2 focus:ring-[#2E3A83]/10"
                            >
