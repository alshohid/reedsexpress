  ...
  return (
    <>
      <div className="flex flex-col gap-3 py-2 md:flex-row md:items-center p-4">
        ...
        <button
          type="button"
          className="inline-flex h-11 items-center gap-2 rounded-xl border border-[#E5E7EB] bg-white px-4 text-sm font-medium text-[#374151]"
        >
          <DownCaretIcon/>
          {selectedRange}
        </button>
        ...
        <table className="w-full border-separate border-spacing-0 text-sm">
          <thead>
            <tr className="text-left text-[11px] font-medium text-[#8B8FA3]">
              ...
              <th className="border-b border-[#EEF0F5] px-4 py-3">Delivery</th>
              <th className="border-b border-[#EEF0F5] px-4 py-3">
                Next Available
              </th>
              ...
              <tr key={index} className="text-[13px] text-[#111827]">
                ...
                <td className="border-b border-[#F3F4F6] px-4 py-4">
                  <div className="space-y-1 text-[#374151]">
                    ...
                    <p className="text-[12px]">
                      <span className="text-[#111827]">To:</span> {row.routeTo}
                    </p>
                  </div>
                </td>
